...
public class PGMTools extends ProkObject {
	...
	public static boolean parseStatic(String arg, String a, String b){
		if(a.equals("kinnercds")){
			...
			calltRNA=call16S=call18S=call5S=call23S=Tools.parseBoolean(b);
		}
